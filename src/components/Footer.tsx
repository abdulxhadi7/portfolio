...
export default function Footer() {
  return (
    <footer className="relative w-full bg-gradient-to-b from-black to-green-950 text-white py-12 sm:py-16 px-6 sm:px-8 overflow-hidden">
      {/* Floating Buttons (hidden on very small screens) */}
      {[
      ...
      <motion.div
        ...
        className="w-full grid grid-cols-1 md:grid-cols-3 gap-10 sm:gap-12 text-center md:text-left relative z-20"
      >
        {/* About */}
        ...
        <div className="space-y-4">
          ...
          <a
            ...
            className="block text-sm sm:text-base hover:text-lime-400 transition-colors break-words"
          >
          ...
          <a
            ...
            target="_blank"
            className="inline-flex items-center justify-center gap-2 bg-lime-500 text-black font-semibold px-4 sm:px-5 py-2 rounded-lg shadow-md hover:bg-lime-600 transition text-sm sm:text-base"
          >
        ...
        <div className="space-y-4">
          ...
          <a
            ...
            target="_blank"
            className="block text-xs sm:text-sm text-gray-400 hover:text-purple-400 transition"
          >
            Server: Strange Zone
          </a>
        </div>
