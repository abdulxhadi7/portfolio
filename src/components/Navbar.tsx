    ...
    <>
      ...
      >
        <div className="relative">
          {/* Animated Gradient Blob (unchanged) */}
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            {/* ⭐ THIN GLOSSY LINE (kept exactly as you had it) */}
            <div className="absolute top-0 left-0 w-full h-[1px] z-[5] bg-gradient-to-r from-white/40 via-white/10 to-white/40 pointer-events-none" />
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="md:hidden mt-3 bg-white/10 border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)] rounded-2xl backdrop-saturate-150 px-6 py-4 z-50"
            >
